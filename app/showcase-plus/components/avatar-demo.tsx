  ...
  return (
    <div className="flex flex-row flex-wrap items-center gap-4">
      <Avatar>
        ...
        <AvatarFallback randomizeColor>CN</AvatarFallback>
      </Avatar>
      <Avatar>
        <AvatarFallback randomizeColor>CN</AvatarFallback>
      </Avatar>
      <Avatar>
        <AvatarFallback randomizeColor>TD</AvatarFallback>
      </Avatar>
      ...
      <Avatar className="rounded-lg">
        <AvatarImage
          ...
          alt="@evilrabbit"
        />
        <AvatarFallback randomizeColor>ER</AvatarFallback>
      </Avatar>
      <div className="*:data-[slot=avatar]:ring-background flex -space-x-2 *:data-[slot=avatar]:ring-2 *:data-[slot=avatar]:grayscale">
        ...
        <Avatar>
          ...
          <AvatarFallback randomizeColor>LR</AvatarFallback>
        </Avatar>
        <Avatar>
          <AvatarImage
            src="https://github.com/evilrabbit.png"
